...
Unit hodgkin_huxley_squid_axon_model_1952_modified_unit;
...
Type
   Thodgkin_huxley_squid_axon_model_1952_modified = Class
      Public
         //---------------------------------------------------------------------
         // State variables
         //---------------------------------------------------------------------
...
Procedure Thodgkin_huxley_squid_axon_model_1952_modified.Init;
Begin
   //---------------------------------------------------------------------------
   // State variables
   //---------------------------------------------------------------------------
...
Procedure Thodgkin_huxley_squid_axon_model_1952_modified.Compute(Const time: Double);
Begin
   ...
   i_Na := g_Na*Power(Y[3], 3.0)*Y[2]*(Y[0]-E_Na);
   i_K := g_K*Power(Y[1], 4.0)*(Y[0]-E_K);
